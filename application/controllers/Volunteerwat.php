<?php
class Volunteerwat extends CI_Controller
{

    public $table_name = '';
    public $content_type = '1';
    public $view_path = 'volunteerwat';
    public $my_temple_id = '';
    ...
    {
        $t1 = $this->db->dbprefix('register_wat');
        ...
        // search
        $temple_name = (isset($_REQUEST['temple_name'])) ? $_REQUEST['temple_name'] : '';
        ...
        if (!empty($temple_name)) {
            $this->db->like('t1.temple_name', $temple_name);
        }
        ...
        $this->db->from($t1);
        if (!empty($temple_name)) {
            $this->db->like('temple_name', $temple_name);
        }
