<?php
class Sandbox1 extends CI_Controller
{

    public $table_name = '';
    public $content_type = '12';
    public $view_path = 'sandbox1';
    public $my_temple_id = '';
    ...
    public function save2()
    {
        ...
        if ($this->db->insert($this->table_name, $data)) {
            redirect($this->view_path . '/edit2?code=success&str=Publish data sucess');
        } else {
            redirect($this->view_path . '/edit2?code=danger&str=Publish data error');
        }
    }
    public function edit2($id = '15')
    {
        $this->load->model('common_model');
        $data['temple'] = $this->common_model->temples();
        ...
        $this->load->view('layouts/admin_header');
        $this->load->view($this->view_path . '/edit2', $data);
        $this->load->view('layouts/admin_footer');
    }
    ...
    public function edit_data2()
    {
        ...
        redirect($this->view_path . '/edit2/?code=success&str=Edit data sucess');
    }
