                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <select class="form-control" name="cate_id" id="cate_id">
                                ...
                                <?php foreach (ACTIVITY_CATE as $key_cate => $val_cate) {?>
...
?>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="event_date">วันที่จัดกิจกรรม</label>
                        <div class="col-lg-4">
...
<script type="text/javascript">
    ...
    <?php if ((!empty($query[0]->lat) && $query[0]->lat > 0) && (!empty($query[0]->lng) && $query[0]->lng > 0)) {?>
        my_location = {lat:<?php echo $query[0]->lat ?>,lng:<?php echo $query[0]->lng ?>};
        initMap('map',my_location);
    ...
    function list_image(){
        ...
        $.get( "<?php echo site_url('activity/list_file/' . $query[0]->id) ?>", function( data ) {
    ...
    function delete_file(id,path){
        if(confirm('คุณต้องการลบข้อมูลนี้ใช่หรือไม่?')){
            $.ajax({
                method: "POST",
                url: "<?php echo site_url('activity/delete_file/' . $query[0]->id) ?>",
                data: { pos: id }
            }).done(function( msg ) {
 ...
 $(function() {
    ...
    var myDropzone = new Dropzone("div#myDropzone", {
        url: "<?php echo site_url('activity/upload') ?>",
        paramName: "file",
