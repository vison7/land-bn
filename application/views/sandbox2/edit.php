        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class="panel-heading-controls">
                    <button class="btn btn-sm btn-primary btn-outline" onclick="location.href = '<?php echo site_url('sandbox2') ?>';"><span class="fa fa-chevron-left"></span>&nbsp;&nbsp;Back</button>
                </div>
            </div>
            <div class="panel-body">

                <form class="form-horizontal" id="form-validate"
                      action="<?php echo site_url('sandbox2/edit_data') ?>" role="form"
                    ...
                    <div class="form-group">
                        ...
                        <?php }?>
                            <button type="button" class="btn btn-default"
                                    onclick="location.href = '<?php echo site_url('sandbox2') ?>';">Back</button>
                        </div>
                    </div>
                </form>
            </div>
