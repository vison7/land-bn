<div class="page-header">
    <h1><i class="fa fa-list-alt page-header-icon"></i>&nbsp;&nbsp;รูปภาพ</h1>
</div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class="panel-heading-controls">
                    <button class="btn btn-sm btn-primary btn-outline" onclick="location.href = '<?php echo site_url('photo') ?>';"><span class="fa fa-chevron-left"></span>&nbsp;&nbsp;Back</button>
                </div>
            </div>
            <div class="panel-body">

                <form class="form-horizontal" id="form-validate"
                      action="<?php echo site_url('photo/edit_data') ?>" role="form"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <select class="form-control" name="cate_id" id="cate_id">
                                ...
                                <?php foreach (MEDIA_PHOTO_CATE as $key_cate => $val_cate) {?>
                    ...
                    <div class="form-group">
                        ...
                        <?php }?>
                            <button type="button" class="btn btn-default"
                                    onclick="location.href = '<?php echo site_url('photo') ?>';">Back</button>
                        </div>
                    </div>
                </form>
            </div>
