        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form-validate"
                      action="<?php echo site_url('lesson/add_data') ?>" role="form"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea cols="70" rows="5" name="embed_vdo" id="embed_vdo" style="width:100%;"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="name">รายละเอียดโดยย่อ</label>
                        <div class="col-lg-8">
                            <textarea cols="70" rows="8" name="description" id="description" style="width:100%;"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea cols="70" rows="4" name="question<?php echo $n?>" id="question<?php echo $n?>" style="width:100%;"></textarea>
                        </div>
                    </div>
                    <?php }?>
