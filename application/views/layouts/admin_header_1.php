<?php
$this->db->from($this->db->dbprefix('sub_menu'));
$this->db->where('is_level', 1);
$this->db->order_by("id", "ASC");
$main_submenu = $this->db->get()->result();
?>
<!DOCTYPE html>
...
<html class="gt-ie8 gt-ie9 not-ie">
    ...
    <body class="theme-default main-navbar-fixed">
            ...
            <div id="main-menu" role="navigation">
                <div id="main-menu-inner">
                    ...
                    <ul class="navigation">
                        ...
                        <li>
                            <a href="<?php echo site_url('staff') ?>"><i class="menu-icon fa fa-th-list"></i><span class="mm-text">TMT Officer</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('banner') ?>"><i class="menu-icon fa fa-tasks"></i><span class="mm-text">App Banner</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('news') ?>"><i class="menu-icon fa fa-th-list"></i><span class="mm-text">News & Event</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('welfare') ?>"><i class="menu-icon fa fa-th-list"></i><span class="mm-text">Welfare</span></a>
                        </li>
                        <li class="mm-dropdown">
                            <a href="#"><i class="menu-icon fa fa-th"></i><span class="mm-text">Welfare</span></a>
                            <ul>
                                <?php foreach ($main_submenu as $row){?>
                                <li>
                                    <a tabindex="-1" href="<?php echo site_url('submenu2?menu_id='. $row->id)?>"><span class="mm-text"><?php echo $row->title?></span></a>
                                </li>
                                <?php }?>
                                <li>
                                    <a tabindex="-1" href="<?php echo site_url('submenu') ?>"><i class="menu-icon fa fa-plus-circle"></i>Add Main Sub menu</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="<?php echo site_url('regulation') ?>"><i class="menu-icon fa fa-th-list"></i><span class="mm-text">Regulation</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('notifications') ?>"><i class="menu-icon fa fa-th-list"></i><span class="mm-text">Notifications Message</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('content') ?>"><i class="menu-icon fa fa-th-list"></i><span class="mm-text">Stat</span></a>
                        </li>
                        <?php if (get_admin_login()->is_level == '1') { ?>
                            <li><a href="<?php echo site_url('user') ?>">
                                    <i class="menu-icon fa fa-user"></i><span class="mm-text">Admin Users</span>
                                </a></li>
                        <?php } ?>
                    </ul>
                    <!-- / .navigation -->
