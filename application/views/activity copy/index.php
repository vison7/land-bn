    ...
    <div class="panel-heading">
        <span class="panel-title">
            ...
            <button type="button" class="btn btn-sm btn-primary"
                    onclick="location.href = '<?php echo site_url('activity/add'); ?>';">
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-xs btn-labeled btn-info"
                                    onclick="location.href = '<?php echo site_url('activity/edit/' . $row->id) ?>';">
                            ...
                            <!-- <?php if($row->cate_id=='1' || $row->cate_id=='2'){?>
                            <button type="button" class="btn btn-xs btn-labeled btn-success"
                                    onclick="location.href = '<?php echo site_url('volunteer?id=' . $row->id) ?>';">
                                <span class="btn-label icon fa fa-user"></span>
                                ผู้สมัคร
                            </button>
                            <?php }?> -->
                        </td>
